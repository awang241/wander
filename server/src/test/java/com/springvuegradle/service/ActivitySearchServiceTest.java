...
public class ActivitySearchServiceTest {
    ...
    void adminCanSeeAllActivitiesInWorld() {
        List<ActivityLocationResponse> expected = activityService.createActivityLocationResponse(List.of(
                ...
                privateActivityManila,
                publicActivityDelaware));
        List<ActivityLocationResponse> actual = activitySearchService.getActivitiesInRange(1L, true, 1000000000, WELLINGTON_LATITUDE, WELLINGTON_LONGITUDE, noActivityTypes, null);
    ...
    void adminCanSeeAllActivitiesWithinNewZealand() {
        assertEquals(activityService.createActivityLocationResponse(List.of(
                ...
                publicActivityChristchurch,
                publicActivityWellington
        )), activitySearchService.getActivitiesInRange(1L, true, 450000, CHRISTCHURCH_LATITUDE, CHRISTCHURCH_LONGITUDE, noActivityTypes, null));
    }
    ...
    void adminCanSeeALlActivitiesWithinOceaniaAndAsia() {
        ...
        List<ActivityLocationResponse> actual = activitySearchService.getActivitiesInRange(1L, true, 9000000, WELLINGTON_LATITUDE, WELLINGTON_LONGITUDE, noActivityTypes, null);
    ...
    void userCanSeePublicActivitiesInChristchurch() {
        ...
        List<ActivityLocationResponse> actual = activitySearchService.getActivitiesInRange(profile.getId(), false, 100000, CHRISTCHURCH_LATITUDE + 0.1, CHRISTCHURCH_LONGITUDE + 0.1, noActivityTypes, null);
        assertTrue(expected.size() == actual.size() &&
                new HashSet(expected).equals(new HashSet(actual)));
    }
    ...
    void userCanSeePublicActivitiesInNewZealand() {
        ...
        List<ActivityLocationResponse> actual = activitySearchService.getActivitiesInRange(profile.getId(), false, 500000, CHRISTCHURCH_LATITUDE + 0.1, CHRISTCHURCH_LONGITUDE + 0.1, noActivityTypes, null);
        assertTrue(expected.size() == actual.size() &&
                new HashSet(expected).equals(new HashSet(actual)));
    }
    ...
    void creatorOfActivityCanSeeTheirOwnActivitysNewZealand(){
        ...
        List<ActivityLocationResponse> actual = activitySearchService.getActivitiesInRange(creator.getId(), false, 500000, WELLINGTON_LATITUDE + 0.1, WELLINGTON_LONGITUDE + 0.1, noActivityTypes, null);
        assertTrue(expected.size() == actual.size() &&
                new HashSet(expected).equals(new HashSet(actual)));
    }
    ...
    void userCanSeePublicActivitiesInWorld() {
        ...
        List<ActivityLocationResponse> actual = activitySearchService.getActivitiesInRange(profile.getId(), false, 500000000, DELAWARE_LATITUDE, DELAWARE_LONGITUDE, noActivityTypes, null);
        assertTrue(expected.size() == actual.size() &&
                new HashSet(expected).equals(new HashSet(actual)));
    }
